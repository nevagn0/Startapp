                ...
                <div style={{ maxWidth: '720px', width: '100%', textAlign: 'left', padding: '0 24px' }}>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            Пользователей сайта <strong>[Адрес сайта]</strong> (далее — Сайт).
                        </p>
                        <p>
                            Оператор: <strong>[Ваше ФИО или название организации]</strong>, ИНН [Ваш ИНН],
                            e‑mail: <a href="mailto:[Ваш e-mail]">[Ваш e-mail]</a>.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            а также отозвать согласие, направив запрос на <a href="mailto:[Ваш e-mail]">[Ваш e-mail]</a>.
                        </p>
                    </section>
